...
int main()
{
	...
	Shader ourShader("system/vShader.vs", "system/fShader_model_geometry.fs", "system/gShader_model.gs");
	Shader normalShader("system/vShader_normal.vs", "system/fShader_normal.fs", "system/gShader_normal.gs");
	...
	while (!glfwWindowShouldClose(window.window))
	{
		...
		normalShader.set("view", camera.view);
